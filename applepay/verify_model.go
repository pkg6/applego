...
func (v *VerifyResponse) LatestReceiptInfoOrderByExpiresDate() []*LatestReceiptInfo {
	return utility.OrderBy[*LatestReceiptInfo, int64](v.LatestReceiptInfo, func(t *LatestReceiptInfo) int64 {
...
func (p *LatestReceiptInfo) ExpiresDateTime() (time.Time, error) {
	return utility.MilliStrToTime(p.ExpiresDateTimestamp)
}
func (p *LatestReceiptInfo) PurchaseDateTime() (time.Time, error) {
	return utility.MilliStrToTime(p.PurchaseDateTimestamp)
}
...
func (p *InApp) OriginalPurchaseDateTime() (time.Time, error) {
	return utility.MilliStrToTime(p.OriginalPurchaseDateTimestamp)
}
